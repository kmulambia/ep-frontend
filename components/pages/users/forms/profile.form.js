                    ...
                    {({ touched, errors, isSubmitting, values }) =>
                        <Form>
                            <div className="space-y-6">
                                ...
                                <div>
                                    <h1 className="text-lg leading-6 font-medium text-gray-900 capitalize">{this.props.t('manage_page.components.account.title', { ns: 'users' })}</h1>
                                    <p className="mt-1 text-sm text-gray-500">
                                        {this.props.t('manage_page.components.account.details', { ns: 'users' })}
                                    </p>
                                </div>
                                <div>
                                    <label
