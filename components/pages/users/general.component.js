            ...
            <React.Fragment>
                <div className="max-w-lg mx-auto lg:pb-16 px-4 py-3 flex flex-col space-y-4">
                    <div className="flex flex-col space-y-4 ">
                        <div>
                            <h1 className="text-lg leading-6 font-medium text-gray-900 capitalize">{this.props.t('manage_page.components.profile.title', { ns: 'users' })}</h1>
                            <p className="mt-1 text-sm text-gray-500">
                                {/* {this.props.t('manage_page.components.profile.details', { ns: 'users' })} */}
                            </p>
                        </div>
                        <div >
