    ...
    constructor(props) {
        ...
        this.state = {
            columns: [
                ...
                {
                    field: "status", type:"boolean",hideable: false, headerName: this.props.t('models.log.status', { ns: 'common' }), flex: 0.3, minWidth: 50, headerClassName: 'bg-slate-100 px-3 py-3.5 text-left text-gray-900 capitalize text-lg  font-bold',
                    valueGetter: ({ value }) => {
                        return value ;
                    },
                },
