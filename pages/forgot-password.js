...
import ForgotPasswordForm from "../components/pages/auth/forms/forgot-password.form";
        ...
        userStore.
            ...
            .then((result) => {
                Swal.fire({
                    ...
                    html: this.props.t('forgot_password_page.notification.success', { ns: 'auth' }),
                        ...
                        <div className="relative max-w-xl mx-auto">
                            ...
                            <div className="text-center">
                                <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:tracking-tight">
                                    {this.props.t('forgot_password_page.title', { ns: 'auth' })}
                                </h2>
                                <p className="mt-4 text-lg leading-6 text-gray-500">
                                    {this.props.t('forgot_password_page.enter_email_address', { ns: 'auth' })}
                                </p>
                            </div>
                            <div className="mt-12" >
                                {/*signup form */}
