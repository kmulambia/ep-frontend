...
import ResetPasswordForm from "../../components/pages/auth/forms/reset-password.form";
        ...
        userStore
            ...
            .then((response) => {
                Swal.fire({
                    ...
                    html: this.props.t('reset_password_page.notification.success', { ns: 'auth' }),
                ...
                switch (error.statusCode) {
                    case 401:
                            Swal.fire({
                                ...
                                icon: 'error',
                                width: 450,
                                html: this.props.t('reset_password_page.notification.failed_invalid_tokken', { ns: 'auth' }),
                                cancelButtonText: this.props.t('forms.dismiss', { ns: 'common' }),
                                confirmButtonText: this.props.t('forms.okay', { ns: 'common' }),
                                buttonsStyling: false,
                                customClass: {
                    ...
                    default:
                        Swal.fire({
                            ...
                            icon: 'error',
                            width: 450,
                            html: this.props.t('password_reset_page.notification.failed_bad_network', { ns: 'auth' }),
                            cancelButtonText: this.props.t('forms.dismiss', { ns: 'common' }),
                            confirmButtonText: this.props.t('forms.okay', { ns: 'common' }),
                            buttonsStyling: false,
                            customClass: {
                        ...
                        <div className="relative max-w-xl mx-auto">
                            ...
                            <div className="text-center">
                                <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:tracking-tight">
                                    {this.props.t('reset_password_page.title', { ns: 'auth' })}
                                </h2>
                                <p className="mt-4 text-lg leading-6 text-gray-500">
                                    {this.props.t('reset_password_page.enter_new_password', { ns: 'auth' })}
                                </p>
                            </div>
                            <div className="mt-12" >
                                {/*signup form */}
                                <ResetPasswordForm token={this.state.token} resetPassword={this.resetPassword} />
                                {/***/}
                            </div>
                            <div className="mt-12">
                                <Link href="/signin">
...
export async function getServerSideProps(context) {
    ...
    return {
        props: { id, ...(await serverSideTranslations(context.locale, ['auth', 'common'])), },
